...
int32_t epos_Transmit_PDO_n_Parameter(uint16_t node_id, uint8_t n,
                                      uint32_t cob);

int32_t epos_Transmit_PDO_n_Mapping(uint16_t node_id, uint8_t n,
                  uint8_t num_objects, Epos_pdo_mapping* objects);
...
int32_t epos_Miscellaneous_Configuration(uint16_t node_id,
                                         uint16_t value);
...
int32_t epos_Position_Mode_Setting_Value(uint16_t node_id,
                                         int32_t value);
...
int32_t epos_Software_Position_Limit(uint16_t node_id, int32_t min,
                                     int32_t max);

/** Motor [rpm] Default 25000 */
int32_t epos_Maximal_Profile_Velocity(uint16_t node_id,
                                      uint32_t value);
...
int32_t epos_Motion_Profile_Type(uint16_t node_id,
                                 enum Epos_Profile_Type mode);
